...
serve(async (req) => {
  ...
  try {
    ...
    const emailHtml = [
      ...
      // plain paragraph.
      '    <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 0.9rem 1.1rem; margin: 0 0 1.5rem; font-size: 0.85rem; color: #166534; line-height: 1.5;">',
